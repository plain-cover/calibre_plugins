...
class BookTestData:
    ...
    def __init__(
        ...
        #   "comments": lambda x: ... validator (x is mi.comments, an HTML string or None)
...
TEST_BOOKS = [
    ...
    BookTestData(
        ...
        expected_fields={
            ...
            "comments": lambda x: x is not None and len(x) > 50 and "Elizabeth Bennet" in x,
            "steam": 1,
    ...
    BookTestData(
        ...
        expected_fields={
            ...
            "series": None,
            "pubdate": (2012, 2, 26),
            "comments": lambda x: x is not None and len(x) > 50 and "Brodey Lyall" in x,
    ...
    BookTestData(
        ...
        expected_fields={
            ...
            "series_index": 3.0,
            "pubdate": (2022, 2, 22),
            "comments": lambda x: x is not None and len(x) > 50 and "Taavi Empire" in x,
            "steam": lambda x: x is not None and 1 <= x <= 5,
            "star_rating": lambda x: x is not None and 0 <= x <= 5,
            "rating_count": lambda x: x is not None and x >= 0,
            "tags": lambda x, delimiter: x is not None and len(x.split(delimiter)) > 0,
    ...
    BookTestData(
        ...
        expected_fields={
            ...
            "series_index": 1.0,
            "pubdate": (2023, 9, 5),
            "comments": lambda x: x is not None and len(x) > 50 and "Lady Katarina Ashowan" in x,
            "steam": lambda x: x is not None and 1 <= x <= 5,
            "star_rating": lambda x: x is not None and 0 <= x <= 5,
            "rating_count": lambda x: x is not None and x >= 0,
            "tags": lambda x, delimiter: x is not None and len(x.split(delimiter)) > 0,
    ...
    BookTestData(
        ...
        expected_fields={
            ...
            "series_index": 2.0,
            "pubdate": (2025, 3, 3),
            "comments": lambda x: x is not None and len(x) > 50 and "Soren" in x,
            "steam": lambda x: x is not None and 1 <= x <= 5,
            "star_rating": lambda x: x is not None and 0 <= x <= 5,
            "rating_count": lambda x: x is not None and x >= 0,
            "tags": lambda x, delimiter: x is not None and len(x.split(delimiter)) > 0,
    ...
    BookTestData(
        ...
        expected_fields={
            ...
            "series": None,
            "pubdate": (2019, 5, 9),
            "comments": lambda x: x is not None and len(x) > 50 and "hated villain" in x,
            "star_rating": lambda x: x is not None and 0 <= x <= 5,
            "rating_count": lambda x: x is not None and x >= 0,
            "tags": lambda x, delimiter: x is not None and len(x.split(delimiter)) > 0,
        },
    ...
    BookTestData(
        ...
        expected_fields={
            ...
            "series_index": 3.0,
            "pubdate": (2025, 2, 11),
            "comments": lambda x: x is not None and len(x) > 50 and "Doctor Fionn Kane" in x,
            "steam": lambda x: x is not None and 1 <= x <= 5,
            "star_rating": lambda x: x is not None and 1 <= x <= 5,
            "rating_count": lambda x: x is not None and x >= 0,
            "tags": lambda x, delimiter: x is not None and len(x.split(delimiter)) > 0,
    ...
    BookTestData(
        ...
        expected_fields={
            ...
            "series_index": 32.0,
            "pubdate": (2011, 2, 1),
            "comments": lambda x: x is not None and len(x) > 50 and "Detective Eve Dallas" in x,
            "steam": lambda x: x is not None and 1 <= x <= 5,
            "star_rating": lambda x: x is not None and 1 <= x <= 5,
            "rating_count": lambda x: x is not None and x >= 0,
            "tags": lambda x, delimiter: x is not None and len(x.split(delimiter)) > 0,
    ...
    BookTestData(
        ...
        expected_fields={
            ...
            "series_index": 4.0,
            "pubdate": (2020, 7, 24),
            "comments": lambda x: x is not None and len(x) > 50 and "Faldine" in x,
            "star_rating": lambda x: x is not None and 0 <= x <= 5,
            "rating_count": lambda x: x is not None and x >= 0,
            "tags": lambda x, delimiter: x is not None and len(x.split(delimiter)) > 0,
        },
    ...
    BookTestData(
        ...
        expected_fields={
            ...
            "series": None,
            "pubdate": (2024, 4, 23),
            "comments": lambda x: x is not None and len(x) > 50 and "pair of opposites" in x,
            "steam": lambda x: x is not None and 1 <= x <= 5,
            "star_rating": lambda x: x is not None and 0 <= x <= 5,
            "rating_count": lambda x: x is not None and x >= 0,
            "tags": lambda x, delimiter: x is not None and len(x.split(delimiter)) > 0,
    ...
    BookTestData(
        ...
        expected_fields={
            ...
            "series_index": 1.25,
            "pubdate": (2018, 4, 24),
            "comments": lambda x: x is not None and len(x) > 50 and "Prince Raiden" in x,
            "star_rating": lambda x: x is not None and 0 <= x <= 5,
            "rating_count": lambda x: x is not None and x >= 0,
            "tags": lambda x, delimiter: x is not None and len(x.split(delimiter)) > 0,
        },
    ...
    BookTestData(
        ...
        expected_fields={
            ...
            "series_index": 1.0,
            "pubdate": (2023, 11, 3),
            "comments": lambda x: x is not None and len(x) > 50 and "Lydia Alcott" in x,
            "steam": lambda x: x is not None and 1 <= x <= 5,
            "star_rating": lambda x: x is not None and 0 <= x <= 5,
            "rating_count": lambda x: x is not None and x >= 0,
            "tags": lambda x, delimiter: x is not None and len(x.split(delimiter)) > 0,
    ...
    BookTestData(
        ...
        expected_fields={
            ...
            "series_index": 3.0,
            "pubdate": (2021, 10, 18),
            "comments": lambda x: x is not None and len(x) > 50 and "Anteverse" in x,
            "star_rating": lambda x: x is not None and 0 <= x <= 5,
            "rating_count": lambda x: x is not None and x >= 0,
            "tags": lambda x, delimiter: x is not None and len(x.split(delimiter)) > 0,
        },
    ...
    BookTestData(
        ...
        expected_fields={
            ...
            "series_index": 1.0,
            "pubdate": (1986, 1, 1),
            "comments": lambda x: x is not None and len(x) > 50 and "Cordelia Naismith" in x,
            "steam": lambda x: x is not None and 1 <= x <= 5,
            "star_rating": lambda x: x is not None and 0 <= x <= 5,
            "rating_count": lambda x: x is not None and x >= 0,
            "tags": lambda x, delimiter: x is not None and len(x.split(delimiter)) > 0,
    ...
    BookTestData(
        ...
        expected_fields={
            ...
            "series": None,
            "pubdate": (2022, 6, 7),
            "comments": lambda x: x is not None and len(x) > 50 and "Shy Wolf Sanctuary" in x,
            "star_rating": lambda x: x is not None and 0 <= x <= 5,
            "rating_count": lambda x: x is not None and x >= 0,
            "tags": lambda x, delimiter: x is not None and len(x.split(delimiter)) > 0,
        },
    ...
    BookTestData(
        ...
        expected_fields={
            ...
            "series": None,
            "pubdate": (2019, 6, 23),
            "comments": lambda x: x is not None and len(x) > 50 and "Cameron Stanton" in x,
            "steam": lambda x: x is not None and 1 <= x <= 5,
            "star_rating": lambda x: x is not None and 0 <= x <= 5,
            "rating_count": lambda x: x is not None and x >= 0,
            "tags": lambda x, delimiter: x is not None and len(x.split(delimiter)) > 0,
    ...
    BookTestData(
        ...
        expected_fields={
            ...
            "series_index": 1.0,
            "pubdate": (2021, 3, 1),
            "comments": lambda x: x is not None and len(x) > 50 and "Hostess cupcakes" in x,
    ...
    BookTestData(
        ...
        expected_fields={
            ...
            "series": None,
            "pubdate": (2021, 10, 12),
            "comments": lambda x: x is not None and len(x) > 50 and "Victoria Clemenceaux" in x,
            "steam": lambda x: x is not None and 1 <= x <= 5,
            "star_rating": lambda x: x is not None and 0 <= x <= 5,
            "rating_count": lambda x: x is not None and x >= 0,
            "tags": lambda x, delimiter: x is not None and len(x.split(delimiter)) > 0,
    ...
    BookTestData(
        ...
        expected_fields={
            ...
            "series_index": 2.0,
            "pubdate": (2018, 7, 29),
            "comments": lambda x: x is not None and len(x) > 50 and "Maximus" in x,
            "steam": lambda x: x is None or (1 <= x <= 5),
            "star_rating": lambda x: x is not None and 0 <= x <= 5,
            "rating_count": lambda x: x is not None and x >= 0,
            "tags": lambda x, delimiter: x is not None and len(x.split(delimiter)) > 0,
    ...
    BookTestData(
        ...
        expected_fields={
            ...
            "series_index": 3.0,
            "pubdate": (2020, 6, 11),
            "comments": lambda x: x is not None and len(x) > 50 and "Lola is being hunted" in x,
            "steam": lambda x: x is not None and 1 <= x <= 5,
            "star_rating": lambda x: x is not None and 0 <= x <= 5,
            "rating_count": lambda x: x is not None and x >= 0,
            "tags": lambda x, delimiter: x is not None and len(x.split(delimiter)) > 0,
    ...
    BookTestData(
        ...
        expected_fields={
            ...
            "series_index": 1.0,
            "pubdate": (2024, 10, 15),
            "comments": lambda x: x is not None and len(x) > 50 and "Aspeth Honori" in x,
            "steam": 4,
            "star_rating": lambda x: x is not None and 0 <= x <= 5,
            "rating_count": lambda x: x is not None and x >= 0,
            "tags": lambda x, delimiter: x is not None and len(x.split(delimiter)) > 0,
